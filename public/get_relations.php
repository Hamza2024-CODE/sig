...
try {
    ...
    // 1. Section columns (to know the right column name)
    $section_cols = $pdo->query("DESCRIBE section")->fetchAll();
    ...
    // 5. Sample sections for Taj (1300 and 1301) - only safe columns
    ...
    echo json_encode([
        'status' => 'success',
        'section_columns' => array_column($section_cols, 'Field'),
