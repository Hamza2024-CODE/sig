...
echo "=== INSPECTING SELECT SPEED (NEW FILE) ===\n\n";
...
try {
    ...
    echo "Without FORCE INDEX took: " . round($elapsed1, 4) . " seconds\n";

    // Test 2: With FORCE INDEX
    $start = microtime(true);
    $selectSql2 = "
        SELECT a.IDapprenant as id, a.Nccp as numero_matricule,
               c.Nom as nom, c.Prenom as prenom, 
    ...
    echo "With FORCE INDEX (PRIMARY) took: " . round($elapsed2, 4) . " seconds\n";
