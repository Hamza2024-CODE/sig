...
<head>
    ...
    <title>@yield('title', 'منصة تسيير - وزارة التكوين والتعليم المهنيين')</title>
        ...
        <div class="container-fluid p-0">
            <nav class="navbar navbar-expand-lg p-0">
                ...
                <a class="navbar-brand d-flex align-items-center m-0" href="{{ url('/') }}">
                    <img src="{{ asset('assets/images/logo.png') }}" alt="شعار الوزارة">
                ...
                <div class="collapse navbar-collapse" id="govNavbar">
                    <ul class="navbar-nav mx-auto gov-nav mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('/') ? 'active' : '' }}" href="{{ url('/') }}"><i class="fa-solid fa-house"></i> الرئيسية</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('portal/features') ? 'active' : '' }}" href="{{ url('portal/features') }}"><i class="fa-solid fa-star"></i> ميزات المنصة</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('portal/about') ? 'active' : '' }}" href="{{ url('portal/about') }}"><i class="fa-solid fa-info-circle"></i> عن المنصة</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('portal/how-it-works') ? 'active' : '' }}" href="{{ url('portal/how-it-works') }}"><i class="fa-solid fa-gears"></i> كيفية العمل</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('portal/privacy') ? 'active' : '' }}" href="{{ url('portal/privacy') }}"><i class="fa-solid fa-shield-halved"></i> سياسة الخصوصية</a>
                        </li>
                    </ul>
        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        <img src="{{ asset('assets/images/logo.png') }}" alt="وزارة التكوين المهني" class="footer-brand-logo">
            ...
            <div class="gov-footer-bottom d-flex flex-column flex-md-row justify-content-between align-items-center text-center">
                <div class="mb-3 mb-md-0">
                    <a href="{{ url('portal/about') }}">عن منصة تسيير</a>
