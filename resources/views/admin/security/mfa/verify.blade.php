...
@section('title', 'تحقق الهوية الثنائي (MFA Challenge) — SGFEP')
@section('content')
        ...
        <div class="col-md-8 col-lg-5">
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                ...
                <div class="card-body p-4">
                    ...
                    <form id="verify-form" method="POST" action="{{ request()->is('sig/*') ? '/sig/security/mfa/verify' : '/security/mfa/verify' }}">
                        @csrf
