...
@section('title', 'خريطة الشعب والتخصصات | Cartographie des Spécialités')
...
<div class="container-fluid px-4 py-2">
    ...
    {{-- Main Row Layout (Matches HR Department Style) --}}
    <div class="row g-4">
        ...
        {{-- Left Side: Details & Interactive Panel --}}
        <div class="col-lg-4">
    ...
    {{-- Bottom Section: Global Statistics summary charts --}}
                ...
                <div class="sp-list">
                    ...
                    <div class="mb-2">
                        <div class="sp-item-row">
                            <span class="sp-name" style="font-size:0.75rem; font-weight:600; color:#334155;">{{ mb_strlen($ts['spec_ar'])>35?mb_substr($ts['spec_ar'],0,35).'…':$ts['spec_ar'] }}</span>
                            <span class="sp-cnt" style="font-size:0.72rem; font-weight:800; color:#643edb;">{{ $ts['cnt'] }} عرض</span>
                        </div>
                        <div class="sp-track"><div class="sp-fill" style="width:{{ round(($ts['cnt']/$mx)*100) }}%"></div></div>
                    </div>
                    @endforeach
                </div>
            </div>
