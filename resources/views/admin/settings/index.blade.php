        ...
        <div class="col-12 col-lg-3">
            <div class="glass-panel p-3">
                ...
                <nav class="settings-nav" id="settingsNav">
                    ...
                    <a href="{{ url('dashboard/settings/takwin') }}" class="settings-nav-item">
                        <i class="fa-solid fa-plug-circle-bolt"></i> إعدادات Takwin المتقدمة
                    </a>
                    <a href="{{ url('dashboard/settings/diplome') }}" class="settings-nav-item">
                        <i class="fa-solid fa-palette"></i> تخصيص الشهادات المتقدم
                    </a>
                    <a href="{{ url('dashboard/roles') }}" class="settings-nav-item">
        ...
        <div class="col-12 col-lg-9">
                ...
                <div class="glass-panel p-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6 col-md-4">
                            <a href="{{ $link['url'] }}" class="d-flex align-items-center gap-2 p-3 rounded-3 text-decoration-none"
                               ...
                               onmouseout="this.style.transform='';this.style.boxShadow=''">
                                <i class="fa-solid {{ $link['icon'] }} text-primary" style="width:20px;"></i>
                                <span style="font-size:.83rem;font-weight:700;font-family:'Cairo';color:var(--tx-1);">{{ $link['label'] }}</span>
                            </a>
                        </div>
                        @endforeach
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="p-3 rounded-3" style="background:var(--bg-surface-elevated);border:1px solid var(--border);">
                                ...
                                <form method="POST" action="{{ url('dashboard/settings/update') }}" onsubmit="return confirm('هل أنت متأكد من مسح الكاش الكامل؟')">
                        ...
                        <div class="col-md-6">
                            <div class="p-3 rounded-3" style="background:var(--bg-surface-elevated);border:1px solid var(--border);">
                                ...
                                <a href="{{ url('dashboard/settings/takwin') }}" class="btn btn-primary w-100 fw-bold py-2 rounded-3" style="font-family:'Cairo';">
            ...
            <div class="settings-panel <?= $active_tab==='database' ? 'active':'' ?>" id="tab-database">
                <div class="glass-panel p-4 mb-4">
                            ...
                            <?php foreach ($db_stats['top_tables'] ?? [] as $tbl): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ url('dashboard/database') }}?table=<?= urlencode($tbl['name'] ?? '') ?>"
                    ...
                    <div class="mt-3 d-flex gap-2">
                        <a href="{{ url('dashboard/database') }}" class="btn btn-primary fw-bold py-2 px-4 rounded-3" style="font-family:'Cairo';">
                            <i class="fa-solid fa-table me-1"></i> فتح مدير قاعدة البيانات
                        </a>
                        <a href="{{ url('dashboard/sync') }}" class="btn btn-outline-secondary fw-bold py-2 px-4 rounded-3" style="font-family:'Cairo';">
                    ...
                    <form method="POST" action="{{ url('dashboard/settings/update') }}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <a href="{{ url('dashboard/settings/takwin') }}" class="btn btn-outline-secondary fw-bold py-2 px-4 rounded-3 me-2" style="font-family:'Cairo';">
                    ...
                    <div class="p-3 rounded-4 mb-4" style="background:var(--bg-surface-elevated, #f8fafc);border:1px solid var(--border);">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control border-light bg-white fw-bold text-truncate"
                                   id="user-apiKey"
                                   value="{{ $user_api_key ?? 'لم يتم توليد مفتاح بعد.' }}" readonly
                                ...
                                <tr id="client-row-{{ $client->id }}">
                                    ...
                                    <td>
                                        @if($client->last_used_at)
                                            <span class="text-dark small"><i class="fa-regular fa-clock me-1"></i> {{ ($client->last_used_at instanceof \DateTimeInterface ? $client->last_used_at->format('Y/m/d H:i') : date('Y/m/d H:i', strtotime((string)$client->last_used_at))) }}</span>
                                        @else
                                            <span class="text-muted small">لم يستخدم بعد</span>
                                        @endif
                                    </td>
                                    <td>
                                        <span class="text-muted small">{{ ($client->created_at instanceof \DateTimeInterface ? $client->created_at->format('Y/m/d') : date('Y/m/d', strtotime((string)$client->created_at))) }}</span>
                                    </td>
                                    <td>
                    ...
                    <form method="POST" action="{{ url('dashboard/settings/update') }}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <a href="{{ url('dashboard/settings/diplome') }}" class="btn btn-outline-primary fw-bold py-2 px-4 rounded-3 me-2" style="font-family:'Cairo';">
                                    <i class="fa-solid fa-palette me-1"></i> التخصيص المتقدم
                                </a>
                                <a href="{{ url('dashboard/diplomes') }}" class="btn btn-outline-secondary fw-bold py-2 px-4 rounded-3 me-2" style="font-family:'Cairo';">
            ...
            <div class="settings-panel <?= $active_tab==='documents' ? 'active':'' ?>" id="tab-documents">
                <div class="glass-panel p-4 mb-4">
                    ...
                    <div class="p-3 mb-4 rounded-3" style="background:rgba(26,107,204,.05); border:1.5px solid rgba(26,107,204,.15);">
                        ...
                        <form method="GET" action="{{ url('dashboard/settings') }}" id="docFilterForm" class="row g-3 align-items-end">
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="doc_table" id="docTableSelect" class="form-select form-select-sm" style="font-family:'Cairo';" onchange="this.form.submit()">
                                    <option value="candidat_document" {{ ($selected_table ?? 'candidat_document') === 'candidat_document' ? 'selected' : '' }}>وثائق المترشح (candidat_document)</option>
                                    <option value="candidat_certifscol" {{ ($selected_table ?? '') === 'candidat_certifscol' ? 'selected' : '' }}>الشهادات المدرسية (certifscol)</option>
                                    <option value="candidat_contratapp" {{ ($selected_table ?? '') === 'candidat_contratapp' ? 'selected' : '' }}>عقود التمهين (contratapp)</option>
                                    <option value="encadremen_memo" {{ ($selected_table ?? '') === 'encadremen_memo' ? 'selected' : '' }}>ملفات الإطارات (encadremen_memo)</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="wilaya_id" id="docWilayaSelect" class="form-select form-select-sm" style="font-family:'Cairo';" onchange="filterEtabs(); setTimeout(() => this.form.submit(), 50)">
                                    ...
                                    @foreach ($wilayas ?? [] as $w)
                                        <option value="{{ $w->IDWilayaa }}" {{ ($selected_wilaya ?? null) == $w->IDWilayaa ? 'selected' : '' }}>
                                            {{ $w->Nom }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="etab_id" id="docEtabSelect" class="form-select form-select-sm" style="font-family:'Cairo';">
                                    ...
                                    @foreach ($etablissements ?? [] as $etab)
                                        <option value="{{ $etab->IDEts_Form }}"
                                                data-wilaya="{{ $etab->IDDFEP }}"
                                                {{ ($selected_etab ?? null) == $etab->IDEts_Form ? 'selected' : '' }}>
                                            {{ $etab->Nom }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        @if (($selected_wilaya ?? null) || ($selected_etab ?? null) || ($selected_table ?? 'candidat_document') !== 'candidat_document')
                        <div class="mt-2">
                            <a href="{{ url('dashboard/settings') }}?tab=documents" class="btn btn-sm btn-outline-secondary rounded-pill" style="font-family:'Cairo'; font-size:.78rem;">
                                <i class="fa-solid fa-xmark me-1"></i> إلغاء الفلاتر
                            </a>
                            <span class="text-muted small ms-2" style="font-family:'Cairo';">
                                النتائج مصفاة
                                @if($selected_wilaya ?? null) · حسب الولاية @endif
                                @if($selected_etab ?? null) · حسب المؤسسة @endif
                            </span>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-6 col-md-3">
                            <div class="glass-panel p-3 text-center" style="background: var(--bg-surface-elevated, #f8fafc);">
                                <div style="font-size:1.6rem;font-weight:900;font-family:'Outfit';color:var(--electric);">
                                    {{ number_format($doc_stats['total_candidates'] ?? 0) }}
                                </div>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="glass-panel p-3 text-center" style="background: var(--bg-surface-elevated, #f8fafc);">
                                <div style="font-size:1.6rem;font-weight:900;font-family:'Outfit';color:#0EA66E;">
                                    {{ number_format($doc_stats['synced_documents'] ?? 0) }}
                                </div>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="glass-panel p-3 text-center" style="background: var(--bg-surface-elevated, #f8fafc);">
                                <div style="font-size:1.6rem;font-weight:900;font-family:'Outfit';color:#dc3545;">
                                    {{ number_format($doc_stats['unsynced_documents'] ?? 0) }}
                                </div>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="glass-panel p-3 text-center" style="background: var(--bg-surface-elevated, #f8fafc);">
                                <div style="font-size:1.6rem;font-weight:900;font-family:'Outfit';color:#F0A500;">
                                    {{ $doc_stats['storage_size_mb'] ?? '0.00' }} MB
                                </div>
                    ...
                    <div class="p-3 mb-4 rounded-3 text-right" style="background:var(--bg-surface-elevated); border:1px solid var(--border);">
                        ...
                        <form method="POST" action="{{ url('dashboard/settings/update') }}" id="docSyncForm" class="row g-2 align-items-center">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <input type="hidden" name="csrf_token" value="{{ csrf_token() }}">
                            <input type="hidden" name="section" value="documents_sync">
                            <input type="hidden" name="redirect_tab" value="documents">
                            <input type="hidden" name="doc_table" value="{{ $selected_table ?? 'candidat_document' }}">
                            @if ($selected_wilaya ?? null)
                                <input type="hidden" name="wilaya_id" value="{{ $selected_wilaya }}">
                            @endif
                            @if ($selected_etab ?? null)
                                <input type="hidden" name="etab_id" value="{{ $selected_etab }}">
                            @endif
                    ...
                    <div class="mb-4">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle small mb-0" style="font-family:'Cairo';">
                                ...
                                <tbody>
                                @php $previewDocs = $preview_docs ?? []; @endphp
                                @if (empty($previewDocs))
                                    <tr>
                                ...
                                @else
                                    ...
                                    <tr>
                                        <td class="fw-bold">{{ $doc['owner_name'] ?: '—' }}</td>
                                        <td>
                                            <span class="stat-badge {{ $doc['owner_type'] === 'مكون / إطار' ? 'gold' : 'blue' }}" style="font-size:.7rem;">
                                                {{ $doc['owner_type'] }}
                                            </span>
                                        </td>
                                        <td class="text-muted">{{ $doc['wilaya'] }}</td>
                                        <td class="text-muted" style="max-width:180px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;" title="{{ $doc['institution'] }}">
                                            {{ $doc['institution'] }}
                                        </td>
                                        <td>
                                            <span class="stat-badge green" style="font-size:.7rem;">
                                                <i class="fa-solid fa-file-alt me-1"></i>{{ $doc['doc_label'] }}
                                            </span>
                                        </td>
                                        <td class="text-center">
                                        ...
                                        <td style="max-width:200px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; font-family:'Outfit'; font-size:.75rem; color:var(--tx-3);" title="{{ $doc['path'] }}">
                                            {{ $doc['path'] }}
                                        </td>
                                    </tr>
                                    @endforeach
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="p-3 rounded-3 h-100 text-right" style="background:var(--bg-surface-elevated); border:1px solid var(--border);">
                                ...
                                <form method="POST" action="{{ url('dashboard/settings/update') }}" onsubmit="return confirm('هل أنت متأكد من بدء عملية فحص وتنظيف الملفات اليتيمة؟ قد تستغرق بعض الوقت.')">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <input type="hidden" name="csrf_token" value="{{ csrf_token() }}">
                                    ...
                                    <?php foreach ($backups as $bkp): ?>
                                        <tr>
                                            ...
                                            <td class="text-center d-flex justify-content-center gap-2">
                                                <a href="{{ url('dashboard/settings/backup/download/' . urlencode($bkp['filename'])) }}" 
                                                ...
                                                <form method="POST" action="{{ url('dashboard/settings/update') }}" onsubmit="return confirm('هل أنت متأكد من حذف هذا الملف نهائياً؟')" style="display:inline;">
                                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                    <input type="hidden" name="csrf_token" value="{{ csrf_token() }}">
            ...
            <div class="settings-panel <?= $active_tab==='sovereign' ? 'active':'' ?>" id="tab-sovereign">
                ...
                <div class="glass-panel p-4 mb-4">
                    ...
                    <form method="POST" action="{{ url('dashboard/settings/update') }}" class="p-3 mb-3 rounded-3 text-right" style="background:var(--bg-surface-elevated); border:1.5px solid rgba(26,107,204,.15);">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input type="hidden" name="csrf_token" value="{{ csrf_token() }}">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <select id="genWilayaSelect" class="form-select form-select-sm" style="font-family:'Cairo';">
                                            <option value="">— كل الولايات —</option>
                                            @foreach ($wilayas ?? [] as $w)
                                                <option value="{{ $w->IDWilayaa }}">{{ $w->Nom }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <select name="generate_ets_id" id="genEtabSelect" class="form-select form-select-sm" style="font-family:'Cairo';">
                                            ...
                                            @foreach ($etablissements ?? [] as $etab)
                                                <option value="{{ $etab->IDetablissement }}" data-wilaya="{{ $etab->IDDFEP }}">
                                                    {{ $etab->Nom }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    ?>
                                        <tr>
                                            <td class="text-start" style="font-family:'Outfit'; direction: ltr;">
                                                <code class="fw-bold" style="font-size:.82rem; color:var(--tx-1);">{{ $lk->license_key }}</code>
                                            </td>
                                            <td class="text-start fw-bold" style="font-family:'Cairo';">
                                                {{ $lk->etablissement_name }}
                                            </td>
                                            <td class="text-center">
                                                <span class="stat-badge {{ $statusClass }}">
                                                    <i class="fa-solid fa-circle" style="font-size:.45rem;"></i>
                                                    {{ $statusText }}
                                                </span>
                                            </td>
                                            <td class="text-center">
                                                @if($isActivated)
                                                    <span class="fw-bold text-primary">{{ $lk->user_nom ?? $lk->username }}</span>
                                                    <div class="text-muted" style="font-size:.72rem; font-family:'Outfit';">{{ date('Y-m-d H:i', strtotime($lk->activated_at)) }}</div>
                                                @elseif($lk->user_id)
                                                    <span class="fw-bold text-secondary">{{ $lk->user_nom ?? $lk->username }}</span>
                                            ...
                                            <td class="text-center fw-bold" style="font-family:'Outfit';">
                                                @if($lk->expires_at)
                                                    <span class="{{ $isExpired ? 'text-danger' : 'text-success' }}">
                                                        {{ date('Y-m-d', strtotime($lk->expires_at)) }}
                                                    </span>
                                                @else
                                                    <span class="text-muted">—</span>
                                                @endif
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <!-- Extend Action -->
                                                    @if($isActivated)
                                                        <form method="POST" action="{{ url('dashboard/settings/update') }}" style="display:inline;">
                                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                            <input type="hidden" name="csrf_token" value="{{ csrf_token() }}">
                                                            <input type="hidden" name="section" value="sovereign_extend">
                                                            <input type="hidden" name="key_id" value="{{ $lk->id }}">
                                                    ...
                                                    <!-- Delete Action -->
                                                    <form method="POST" action="{{ url('dashboard/settings/update') }}" onsubmit="return confirm('هل أنت متأكد من إلغاء/حذف هذا المفتاح نهائياً؟')" style="display:inline;">
                                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                        <input type="hidden" name="csrf_token" value="{{ csrf_token() }}">
                        ...
                        <div class="col-md-6">
                            <div class="p-3 rounded-3 text-right h-100 d-flex flex-column justify-content-between" style="background:var(--bg-surface-elevated); border:1.5px solid rgba(26,107,204,.15);">
                                ...
                                <form method="POST" action="{{ url('dashboard/settings/update') }}">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <span class="badge {{ $is_sso_enabled ? 'bg-success' : 'bg-secondary' }} small">
                                            {{ $is_sso_enabled ? 'نشط / Activé' : 'معطل / Désactivé' }}
                                        </span>
                                        <div class="form-check form-switch">
                        ...
                        <div class="col-md-6">
                            <div class="p-3 rounded-3 text-right h-100 d-flex flex-column justify-content-between" style="background:var(--bg-surface-elevated); border:1.5px solid rgba(26,107,204,.15);">
                                ...
                                <form method="POST" action="{{ url('dashboard/settings/update') }}">
                                    ...
                                    <input type="hidden" name="redirect_tab" value="security">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <span class="badge {{ $is_push_enabled ? 'bg-success' : 'bg-secondary' }} small">
                                            {{ $is_push_enabled ? 'نشط / Activé' : 'معطل / Désactivé' }}
                                        </span>
                                        <div class="form-check form-switch">
                        ...
                        <div class="col-md-6">
                            <div class="p-3 rounded-3 text-right h-100 d-flex flex-column justify-content-between" style="background:var(--bg-surface-elevated); border:1.5px solid rgba(26,107,204,.15);">
                                ...
                                <form method="POST" action="{{ url('dashboard/settings/update') }}">
                                    ...
                                    <input type="hidden" name="redirect_tab" value="security">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <span class="badge {{ $is_sse_enabled ? 'bg-success' : 'bg-secondary' }} small">
                                            {{ $is_sse_enabled ? 'نشط / Activé' : 'معطل / Désactivé' }}
                                        </span>
                                        <div class="form-check form-switch">
                        ...
                        <div class="col-md-6">
                            <div class="p-3 rounded-3 text-right h-100 d-flex flex-column justify-content-between" style="background:var(--bg-surface-elevated); border:1.5px solid rgba(26,107,204,.15);">
                                ...
                                <form method="POST" action="{{ url('dashboard/settings/update') }}">
                                    ...
                                    <input type="hidden" name="redirect_tab" value="security">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <span class="badge {{ $is_rate_limiting_enabled ? 'bg-success' : 'bg-secondary' }} small">
                                            {{ $is_rate_limiting_enabled ? 'نشط / Activé' : 'معطل / Désactivé' }}
                                        </span>
                                        <div class="form-check form-switch">
                    ...
                    <div class="row g-3">
                        <div class="col-md-7">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control form-control-sm" readonly style="font-family:'Outfit'; font-size:.78rem;" value="{{ env('VAPID_PUBLIC_KEY', '— غير مهيأ —') }}">
                            </div>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center" style="font-family:'Outfit';">
                                                {{ date('Y-m-d', strtotime($el->start_date)) }}
                                            </td>
                                            <td class="text-center" style="font-family:'Outfit';">
                                                {{ date('Y-m-d', strtotime($el->end_date)) }}
                                            </td>
                                            <td class="text-center text-muted" style="font-family:'Cairo'; max-width: 200px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="{{ $el->reason }}">
                                                {{ $el->reason ?: '—' }}
                                            </td>
                                            <td class="text-center">
                                                <span class="stat-badge {{ $statusClass }}">
                                ...
                                <?php else: ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center" style="font-family:'Outfit';">
                                                <code class="fw-bold text-dark">{{ $ed->code_verification }}</code>
                                            </td>
                                            <td class="text-center" style="font-family:'Outfit';">
                                                {{ date('Y-m-d H:i', strtotime($ed->created_at)) }}
                                            </td>
                                            <td class="text-center">
                                                <span class="stat-badge {{ $statusClass }}">
                                                    <i class="fa-solid fa-circle" style="font-size:.45rem;"></i>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="ministry_name" class="form-control"
                                       value="{{ $ministry->Nom ?? '' }}" style="font-family:'Cairo';">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" name="ministry_name_fr" class="form-control"
                                       value="{{ $ministry->NomFr ?? '' }}" style="font-family:'Outfit';">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="ipsrvhfsql" class="form-control"
                                       value="{{ $ministry->ipsrvhfsql ?? '' }}" style="font-family:'Outfit';">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="number" name="portsrvhfsql" class="form-control"
                                       value="{{ $ministry->portsrvhfsql ?? 4900 }}" style="font-family:'Outfit';">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="ipsrvmysql" class="form-control"
                                       value="{{ $ministry->ipsrvmysql ?? '' }}" style="font-family:'Outfit';">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="number" name="portsrvmusql" class="form-control"
                                       value="{{ $ministry->portsrvmusql ?? 3306 }}" style="font-family:'Outfit';">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="ipsrvftp" class="form-control"
                                       value="{{ $ministry->ipsrvftp ?? '' }}" style="font-family:'Outfit';">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="number" name="portsrvftp" class="form-control"
                                       value="{{ $ministry->portsrvftp ?? 21 }}" style="font-family:'Outfit';">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="ipsrvhttp" class="form-control"
                                       value="{{ $ministry->ipsrvhttp ?? '' }}" style="font-family:'Outfit';">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" name="dnssrvhttp" class="form-control"
                                       value="{{ $ministry->dnssrvhttp ?? '' }}" style="font-family:'Outfit';">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="active_semester_id" class="form-select" style="font-family:'Cairo';">
                                    @foreach($allSemesters as $sem)
                                        <option value="{{ $sem->IDPeriodeencour }}" {{ ($currentSemesterId == $sem->IDPeriodeencour) ? 'selected' : '' }}>
                                            {{ $sem->Nom }} {{ $sem->NomFr ? '('.$sem->NomFr.')' : '' }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nom_user" class="form-control"
                                       value="{{ $ministry->NomUser ?? '' }}" style="font-family:'Outfit';">
                            </div>
            ...
            <div class="settings-panel <?= $active_tab==='landing' ? 'active':'' ?>" id="tab-landing">
                <div class="glass-panel p-4 mb-4">
                    ...
                    <form method="POST" action="{{ url('dashboard/settings/update') }}" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input type="hidden" name="csrf_token" value="{{ csrf_token() }}">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <input type="color" name="landing_primary_color" class="form-control form-control-color" style="width: 50px; height: 38px; padding: 4px;"
                                               value="{{ \App\Helpers\SovereignLicensingHelper::getSetting('landing_primary_color', '#2563EB') }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <input type="color" name="landing_secondary_color" class="form-control form-control-color" style="width: 50px; height: 38px; padding: 4px;"
                                               value="{{ \App\Helpers\SovereignLicensingHelper::getSetting('landing_secondary_color', '#0EA5E9') }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <input type="color" name="landing_bg_color" class="form-control form-control-color" style="width: 50px; height: 38px; padding: 4px;"
                                               value="{{ \App\Helpers\SovereignLicensingHelper::getSetting('landing_bg_color', '#EEF2F6') }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="landing_logo_url" class="form-control" placeholder="assets/images/logo.png" style="font-family:'Outfit';"
                                           value="{{ \App\Helpers\SovereignLicensingHelper::getSetting('landing_logo', 'assets/images/logo.png') }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="landing_hero_title" class="form-control" style="font-family:'Cairo';"
                                           value="{{ \App\Helpers\SovereignLicensingHelper::getSetting('landing_hero_title', 'المنصة الوطنية الموحدة') }}">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="landing_hero_title_gradient" class="form-control" style="font-family:'Cairo';"
                                           value="{{ \App\Helpers\SovereignLicensingHelper::getSetting('landing_hero_title_gradient', 'لتسيير التكوين المهني') }}">
                                </div>
                                <div class="col-12">
                                    <label class="form-label fw-bold small" style="font-family:'Cairo';">الوصف التعريفي للـ Hero</label>
                                    <textarea name="landing_hero_desc" class="form-control" rows="3" style="font-family:'Cairo';">{{ \App\Helpers\SovereignLicensingHelper::getSetting('landing_hero_desc', 'البوابة الرقمية المعتمدة للتسيير الشامل لمسارات التكوين والتعليم المهنيين، تربط جميع المؤسسات عبر 58 ولاية بمركز البيانات الوطني المركزي.') }}</textarea>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="landing_hero_btn1_text" class="form-control" style="font-family:'Cairo';"
                                           value="{{ \App\Helpers\SovereignLicensingHelper::getSetting('landing_hero_btn1_text', 'استكشاف الخدمات') }}">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="landing_hero_btn2_text" class="form-control" style="font-family:'Cairo';"
                                           value="{{ \App\Helpers\SovereignLicensingHelper::getSetting('landing_hero_btn2_text', 'عن المنصة') }}">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="landing_hero_image_url" class="form-control" placeholder="assets/images/hero_erp_generated.png" style="font-family:'Outfit';"
                                           value="{{ \App\Helpers\SovereignLicensingHelper::getSetting('landing_hero_image', 'assets/images/hero_erp_generated.png') }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="landing_features_eyebrow" class="form-control" style="font-family:'Cairo';"
                                           value="{{ \App\Helpers\SovereignLicensingHelper::getSetting('landing_features_eyebrow', 'منصة تسيير الرقمية ERP') }}">
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="landing_features_title" class="form-control" style="font-family:'Cairo';"
                                           value="{{ \App\Helpers\SovereignLicensingHelper::getSetting('landing_features_title', 'تسيير كامل للتكوين المهني') }}">
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="landing_features_btn_text" class="form-control" style="font-family:'Cairo';"
                                           value="{{ \App\Helpers\SovereignLicensingHelper::getSetting('landing_features_btn_text', 'اكتشف كل الميزات') }}">
                                </div>
                            </div>
                        </div>
            ...
            <div class="settings-panel <?= $active_tab==='portal_cms' ? 'active':'' ?>" id="tab-portal_cms">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex align-items-center justify-content-center gap-2">
                                                ...
                                                <form method="POST" action="{{ url('dashboard/settings/update') }}" onsubmit="return confirm('هل أنت متأكد من رغبتك في حذف هذه الصفحة نهائياً؟');">
                                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                    <input type="hidden" name="csrf_token" value="{{ csrf_token() }}">
                ...
                <div class="glass-panel p-4 mb-4" id="portal-pages-form-card" style="display: none;">
                    ...
                    <form method="POST" action="{{ url('dashboard/settings/update') }}" id="portal-cms-form">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input type="hidden" name="csrf_token" value="{{ csrf_token() }}">
            ...
            <div class="settings-panel <?= $active_tab==='feature_flags' ? 'active':'' ?>" id="tab-feature_flags">
                <div class="glass-panel p-4 mb-4">
                    ...
                    <form method="POST" action="{{ url('dashboard/settings/update') }}" class="p-3 mb-3 rounded-3 text-right" style="background:var(--bg-surface-elevated); border:1.5px solid rgba(26,107,204,.12);">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input type="hidden" name="csrf_token" value="{{ csrf_token() }}">
                            ...
                            <table class="table table-hover align-middle mb-0 text-right" dir="rtl" style="font-size:0.83rem;">
                                ...
                                <tbody>
                                    ...
                                    <tr style="border-bottom:1px solid #f1f5f9;">
                                        <td class="fw-bold text-dark py-2 px-3">{{ $w->Nom }}</td>
                                        <td class="text-center py-2">
                                            <input class="form-check-input" type="checkbox" name="wilaya_{{ $w->IDWilayaa }}_add" value="1" <?= $addOk ? 'checked' : '' ?> style="cursor:pointer; width:1.1rem; height:1.1rem;">
                                        </td>
                                        <td class="text-center py-2">
                                            <input class="form-check-input" type="checkbox" name="wilaya_{{ $w->IDWilayaa }}_edit" value="1" <?= $editOk ? 'checked' : '' ?> style="cursor:pointer; width:1.1rem; height:1.1rem;">
                                        </td>
                                        <td class="text-center py-2">
                                            <input class="form-check-input" type="checkbox" name="wilaya_{{ $w->IDWilayaa }}_delete" value="1" <?= $deleteOk ? 'checked' : '' ?> style="cursor:pointer; width:1.1rem; height:1.1rem;">
                                        </td>
                                        <td class="text-center py-2">
                                            <input class="form-check-input" type="checkbox" name="wilaya_{{ $w->IDWilayaa }}_export" value="1" <?= $exportOk ? 'checked' : '' ?> style="cursor:pointer; width:1.1rem; height:1.1rem;">
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
    ...
    if (genWilaya && genEtab && genUser) {
        async function updateSovereignTargets() {
            ...
            try {
                ...
                const response = await fetch('{{ url("dashboard/settings/sovereign/search-targets") }}?wilaya_id=' + wilayaId + '&etab_id=' + etabId);
