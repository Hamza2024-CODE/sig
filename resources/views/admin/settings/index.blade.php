                                ...
                                <tr id="client-row-{{ $client->id }}">
                                    ...
                                    <td>
                                        @if($client->last_used_at)
                                            <span class="text-dark small"><i class="fa-regular fa-clock me-1"></i> {{ date('Y/m/d H:i', strtotime($client->last_used_at)) }}</span>
                                        @else
                                            <span class="text-muted small">لم يستخدم بعد</span>
                                        @endif
                                    </td>
                                    <td>
                                        <span class="text-muted small">{{ date('Y/m/d', strtotime($client->created_at)) }}</span>
                                    </td>
                                    <td>
