<?php $__env->startSection('title', 'نظام دعم القرار الاستراتيجي (DSS)'); ?>
...
<div class="dss-container animate__animated animate__fadeIn" dir="rtl">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4 mt-2">
        ...
        <div class="d-flex gap-2">
            ...
            <form method="GET" action="" class="d-flex gap-2 align-items-center">
                <?php if(in_array($roleCode, ['admin', 'central', 'ministre', 'dfep'])): ?>
                    <select name="filter_wilaya" id="filter_wilaya" class="form-select rounded-pill bg-light border-light" style="min-width: 150px;" onchange="this.form.submit()">
                        ...
                        <?php $__currentLoopData = $wilayas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($w->IDWilayaa); ?>" <?php echo e($dfepId == $w->IDWilayaa ? 'selected' : ''); ?>><?php echo e($w->Nom); ?></option>
                    ...
                    <select name="filter_etablissement" id="filter_etablissement" class="form-select rounded-pill bg-light border-light" style="min-width: 200px;" onchange="this.form.submit()">
                        ...
                        <?php $__currentLoopData = $etablissements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $etab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($etab->IDetablissement); ?>" <?php echo e($etabId == $etab->IDetablissement ? 'selected' : ''); ?>><?php echo e($etab->Nom); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                <?php endif; ?>
    ...
    <div class="row g-4 mb-4">
        <?php $__currentLoopData = $scopedData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $domain => $metrics): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php $__currentLoopData = $metrics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $metric): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="kpi-premium-card" style="background: <?php echo e($gradient); ?>;">
                        <div class="bg-icon"><i class="fa-solid <?php echo e($icon); ?>"></i></div>
                        <div class="small fw-bold opacity-75 mb-1"><i class="fa-solid fa-tags me-1"></i> <?php echo e($metric['name']); ?></div>
                        <div class="fs-2 fw-black font-inter mb-2">
                            <?php if(is_numeric($metric['value'])): ?>
                                <?php if($metric['unit'] === 'دج'): ?>
                                    <?php echo e(number_format($metric['value'], 0, '.', ',')); ?> <span class="fs-6"><?php echo e($metric['unit']); ?></span>
                                <?php else: ?>
                                    <?php echo e(number_format($metric['value'], ($metric['value'] == (int)$metric['value'] ? 0 : 2))); ?><?php echo e($metric['unit']); ?>
                        ...
                        <?php if(isset($metric['trend'])): ?>
                            <div class="border-top pt-2 mt-2 opacity-90 small d-flex flex-wrap justify-content-between align-items-center">
                                <div>
                                    ...
                                    <strong class="font-inter">
                                        <?php echo e(is_numeric($metric['trend']['past_semester_avg']) ? number_format($metric['trend']['past_semester_avg'], ($metric['trend']['past_semester_avg'] == (int)$metric['trend']['past_semester_avg'] ? 0 : 2)) : $metric['trend']['past_semester_avg']); ?><?php echo e($metric['unit']); ?>

                                    </strong>
                                </div>
                                <div class="badge bg-white bg-opacity-20 px-2 py-1 rounded">
                                    <span class="fw-bold font-inter">
                                        <?php echo e($metric['trend']['direction'] === 'up' ? '↗' : '↘'); ?> 
                                        <?php echo e(abs($metric['trend']['change_percent'])); ?>%
                                    </span>
                                </div>
                            </div>
                            <div class="mt-1 small opacity-75">
                                ...
                                <strong class="font-inter"><?php echo e(number_format($metric['trend']['forecast_next_semester'], ($metric['trend']['forecast_next_semester'] == (int)$metric['trend']['forecast_next_semester'] ? 0 : 2))); ?><?php echo e($metric['unit']); ?></strong>
                            </div>
                        <?php endif; ?>

                        <?php if(isset($metric['details'])): ?>
                            <div class="mt-2 border-top pt-2 opacity-90 small">
                                <div class="d-flex justify-content-between">
                                    <?php $__currentLoopData = $metric['details']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detName => $detVal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span><?php echo e($detName); ?>: <strong class="font-inter"><?php echo e(number_format($detVal, 0)); ?> دج</strong></span>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                        <?php endif; ?>
                    ...
                    <?php $__currentLoopData = $recommendations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="recommendation-item">
                            <div class="recommendation-icon">
                                <i class="fa-solid <?php echo e($recIcon); ?> text-white" style="font-size:0.8rem;"></i>
                            </div>
                            <h6 class="fw-bold text-dark mb-1 small"><?php echo e($rec['title']); ?></h6>
                            <p class="text-muted mb-0" style="font-size: 0.85rem; line-height: 1.4;"><?php echo e($rec['text']); ?></p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            ...
            <div class="card border-0 glass-panel-premium p-4 h-100">
                ...
                <div style="max-height: 350px; overflow-y: auto;">
                    <?php $__currentLoopData = $alerts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <div class="alert border-0 mb-3 shadow-sm rounded-4" style="background: <?php echo e($alertColor); ?>; border-right: 5px solid <?php echo e($alertBorder); ?>; color: <?php echo e($alertText); ?>; padding: 1rem;">
                            <div class="d-flex align-items-start gap-2">
                                <i class="fa-solid <?php echo e($alertIcon); ?> mt-1"></i>
                                <div>
                                    <span class="fw-bold d-block small mb-1"><?php echo e($alert['title']); ?></span>
                                    <span style="font-size:0.8rem; line-height: 1.3;"><?php echo e($alert['message']); ?></span>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="card border-0 glass-panel-premium p-4 h-100">
                    ...
                    <div class="table-responsive" style="max-height: 280px; overflow-y: auto;">
                        <table class="table table-hover align-middle small mb-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $drilldownItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="fw-bold"><?php echo e($item['etab_name']); ?></td>
                                        <td><?php echo e($item['wilaya_name']); ?></td>
                                        <td><span class="badge bg-success-subtle text-success fw-bold font-inter"><?php echo e($item['success_rate']); ?>%</span></td>
                                        <td class="font-inter"><?php echo e(number_format($item['budget'], 0)); ?> دج</td>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="progress w-100" style="height: 6px; border-radius: 3px;">
                                                    <div class="progress-bar" role="progressbar" style="width: <?php echo e(min(100, $item['absorption'])); ?>%; background-color: var(--primary-color);" aria-valuenow="<?php echo e($item['absorption']); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                                <span class="font-inter fw-bold"><?php echo e($item['absorption']); ?>%</span>
                                            </div>
                                        </td>
                                        <td class="font-inter"><?php echo e($item['student_teacher_ratio']); ?></td>
                                        <td class="text-center">
                                            <button type="button" class="btn btn-sm btn-primary rounded-pill px-3" 
                                                    data-bs-toggle="modal" 
                                                    data-bs-target="#etabDrilldownModal" 
                                                    onclick="loadEtabDrilldown(<?php echo e($item['etab_id']); ?>)">
...
<script>
    ...
    const forecastChart = new Chart(forecastCtx, {
        ...
        data: {
            ...
            datasets: [{
                label: '<?php echo e($metricLabel); ?>',
                data: [
                    <?php echo e($mainData ? $mainData['past_semester_avg'] : 76.5); ?>,
                    <?php echo e($mainData ? $mainData['current_semester_avg'] : 78.5); ?>,
                    <?php echo e($mainData ? $mainData['forecast_next_semester'] : 80.5); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sig\resources\views/admin/dss/index.blade.php ENDPATH**/ ?>