    ...
    <div class="split-login-container apple-glass-panel">
        ...
        <div class="login-graphic-side">
            ...
            <div class="animate__animated animate__fadeInDown" style="max-width: 440px; z-index: 10;">
                <img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="MFEP Seal" style="height: 100px; margin-bottom: 2rem; filter: drop-shadow(0 8px 16px rgba(0,0,0,0.3));">
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sig\resources\views/auth/login.blade.php ENDPATH**/ ?>