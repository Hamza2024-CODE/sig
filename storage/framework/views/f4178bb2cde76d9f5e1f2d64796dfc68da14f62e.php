<?php $__env->startSection('title', $title ?? 'المنصة الوطنية الموحدة لتسيير التكوين المهني ERP'); ?>
        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-7">
                ...
                <div class="d-flex flex-wrap gap-3">
                    ...
                    <a href="<?php echo e(url('portal/about')); ?>" class="btn-hero-secondary">
            ...
            <div class="col-lg-5 d-none d-lg-flex justify-content-center align-items-center position-relative">
                ...
                <img src="<?php echo e(asset('assets/images/hero_erp_generated.png')); ?>" alt="منصة تسيير التكوين المهني ERP" class="img-fluid hero-laptop-img animate__animated animate__zoomIn">
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-5">
                ...
                <a href="<?php echo e(url('portal/features')); ?>" class="btn-sec-cta">
            ...
            <div class="col-lg-7">
                <div class="feat-orbit-wrap">
                    ...
                    <div class="feat-orbit-center">
                        <img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="شعار" style="width:56px; height:56px; object-fit:contain;">
                    </div>
...
<section class="hiw-section">
    <div class="container text-center">
        ...
        <a href="<?php echo e(url('login')); ?>" class="btn-hiw-cta">
...
<section class="services-strip">
    <div class="container">
        ...
        <div class="sstrip-grid">
            ...
            <a href="<?php echo e(url('portal/nomenclature')); ?>" class="sstrip-card">
            ...
            <a href="<?php echo e(url('portal/directions')); ?>" class="sstrip-card">
            ...
            <a href="<?php echo e(url('login')); ?>" class="sstrip-card">
        ...
        <div class="home-bento-grid">
            ...
            <div class="home-bento-card home-bento-large bento-trainees">
                ...
                <div class="bento-card-content">
                    ...
                    <div class="bento-middle">
                        <div class="bento-num" data-target="<?php echo e($stat_inscrits); ?>">0</div>
            ...
            <div class="home-bento-card home-bento-small bento-etabs">
                ...
                <div class="bento-card-content">
                    ...
                    <div class="bento-middle">
                        <div class="bento-num-sm" data-target="<?php echo e($stat_etablissements); ?>">0</div>
            ...
            <div class="home-bento-card home-bento-small bento-wilayas">
                ...
                <div class="bento-card-content">
                    ...
                    <div class="bento-middle">
                        <div class="bento-num-sm" data-target="<?php echo e($stat_wilayas); ?>">0</div>
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sig\resources\views/home/index.blade.php ENDPATH**/ ?>