...
<!DOCTYPE html>
<html lang="ar" dir="rtl" data-theme="<?php echo e(isset($userPrefs) ? $userPrefs->theme : 'light'); ?>">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title><?php echo $__env->yieldContent('title', 'منصة تسيير | التسيير الرقمي الموحد لقطاع التكوين والتعليم المهنيين'); ?></title>
    ...
    <script>
        (function() {
            var saved = "<?php echo e(isset($userPrefs) ? $userPrefs->theme : ''); ?>";
            if (!saved) {
    ...
    <?php if(isset($userPrefs)): ?>
    <style id="sgfep-user-prefs-styles">
        :root {
            /* Accent color overrides */
            --sovereign-azure: <?php echo e($userPrefs->accent_color ?? '#1a6bcc'); ?>;
            --color-primary: <?php echo e($userPrefs->accent_color ?? '#1a6bcc'); ?>;
            ...
            --electric: <?php echo e($userPrefs->accent_color ?? '#1a6bcc'); ?>;
        }
    ...
    <!-- Font Size Overrides -->
    <?php if(($userPrefs->font_size ?? 'md') === 'sm'): ?>
    ...
    <?php elseif(($userPrefs->font_size ?? 'md') === 'lg'): ?>
    ...
    <?php if(!($userPrefs->animations_enabled ?? true)): ?>
...
<body class="<?php echo e((isset($userPrefs) && $userPrefs->compact_mode) ? 'compact-mode' : ''); ?>">
...
<div class="app-shell">
    ...
    <aside class="sovereign-sidebar" id="sovereignSidebar">
        ...
        <div class="sidebar-logo">
            <img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="Sovereign Seal">
        ...
        <nav class="sidebar-menu">
            <?php if($roleCode === 'apprenant'): ?>
                ...
                <a href="<?php echo e(request()->is('sig/*') ? url('sig/apprenant') : url('apprenant')); ?>" class="sidebar-item <?php echo e(($isActive('/apprenant', true) || $isActive('/sig/apprenant', true)) ? 'active' : ''); ?>" title="الصفحة الرئيسية">
                    <i class="fa-solid fa-house text-success"></i>
                    <span>الصفحة الرئيسية</span>
                </a>
                <a href="<?php echo e(request()->is('sig/*') ? url('sig/apprenant/carte') : url('apprenant/carte')); ?>" class="sidebar-item <?php echo e(($isActive('/apprenant/carte', true) || $isActive('/sig/apprenant/carte', true)) ? 'active' : ''); ?>" title="بطاقة المتكون">
                    <i class="fa-solid fa-id-card text-primary"></i>
                    <span>بطاقة المتكون</span>
                </a>
                <a href="<?php echo e(request()->is('sig/*') ? url('sig/apprenant#notes') : url('apprenant#notes')); ?>" class="sidebar-item" title="نتائجي">
                    <i class="fa-solid fa-chart-line text-warning"></i>
                    <span>نتائجي</span>
                </a>
                <a href="<?php echo e(request()->is('sig/*') ? url('sig/apprenant#emploi') : url('apprenant#emploi')); ?>" class="sidebar-item" title="استعمال الزمن">
                    <i class="fa-solid fa-calendar-week text-info"></i>
                    <span>استعمال الزمن</span>
                </a>
                <a href="<?php echo e(request()->is('sig/*') ? url('sig/apprenant#documents') : url('apprenant#documents')); ?>" class="sidebar-item" title="وثائقي">
                    <i class="fa-solid fa-folder-open text-danger"></i>
                    <span>وثائقي</span>
                </a>
                <a href="<?php echo e(request()->is('sig/*') ? url('sig/apprenant#teachers') : url('apprenant#teachers')); ?>" class="sidebar-item" title="الأساتذة">
                    <i class="fa-solid fa-chalkboard-user" style="color: #8b5cf6;"></i>
                    <span>الأساتذة</span>
                </a>
            <?php else: ?>
                <?php if($isApprenticeshipDept): ?>
                    <!-- ══ فضاء مصلحة التمهين ══ -->
                    <div class="sidebar-section-label"><span>فضاء مصلحة التمهين</span></div>

                    <a href="<?php echo e(url('dashboard')); ?>" class="sidebar-item <?php echo e(($isActive('/dashboard', true) && !isset($_GET['tab'])) ? 'active' : ''); ?>" title="لوحة التحكم">
                    ...
                    <div class="sidebar-dropdown">
                        <button type="button" class="sidebar-item <?php echo e(($isActive('/dashboard/distribution-globale') || $isActive('/dashboard/formation') || $isActive('/dashboard/formateurs') || $isActive('/dashboard/formateurs/age-distribution')) ? 'active' : ''); ?>" onclick="toggleSidebarDropdown(this)" title="تسيير التكوين والخدمات">
                            <i class="fa-solid fa-chalkboard-user text-info"></i>
                            <span>تسيير التكوين والخدمات</span>
                            <i class="fa-solid fa-chevron-down ms-auto dropdown-chevron" style="font-size: 0.7rem;"></i>
                        </button>
                        <div class="sidebar-submenu <?php echo e(($isActive('/dashboard/distribution-globale') || $isActive('/dashboard/formation') || $isActive('/dashboard/formateurs') || $isActive('/dashboard/formateurs/age-distribution')) ? 'open' : ''); ?>">
                            <a href="<?php echo e(url('dashboard/distribution-globale')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/distribution-globale')); ?>" title="التوزيع العام"><i class="fa-solid fa-chart-pie text-info"></i> <span>التوزيع العام</span></a>
                            <a href="<?php echo e(url('dashboard/formation')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/formation')); ?>" title="تسيير التكوين"><i class="fa-solid fa-chalkboard-user text-info"></i> <span>تسيير التكوين</span></a>
                            <a href="<?php echo e(url('dashboard/formateurs')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/formateurs')); ?>" title="ملف الأساتذة"><i class="fa-solid fa-users-rectangle text-info"></i> <span>ملف الأساتذة</span></a>
                            <a href="<?php echo e(url('dashboard/formateurs/age-distribution')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/formateurs/age-distribution')); ?>" title="إحصائيات الأساتذة والسن"><i class="fa-solid fa-chart-line text-info"></i> <span>إحصائيات الأساتذة والسن</span></a>
                        </div>
                    </div>

                    <!-- 3. التقييمات والشهادات -->
                    <div class="sidebar-dropdown">
                        <button type="button" class="sidebar-item <?php echo e(($isActive('/resultats') || $isActive('/dashboard/gestion-evaluations') || $isActive('/dashboard/evaluation-finale') || $isActive('/dashboard/grades/reconduits') || $isActive('/dashboard/grades') || $isActive('/dashboard/reconduits') || $isActive('/dashboard/reconduits/transfers') || $isActive('/dashboard/schedule')) ? 'active' : ''); ?>" onclick="toggleSidebarDropdown(this)" title="التقييمات والشهادات">
                            <i class="fa-solid fa-list-check text-warning"></i>
                            <span>التقييمات والشهادات</span>
                            <i class="fa-solid fa-chevron-down ms-auto dropdown-chevron" style="font-size: 0.7rem;"></i>
                        </button>
                        <div class="sidebar-submenu <?php echo e(($isActive('/resultats') || $isActive('/dashboard/gestion-evaluations') || $isActive('/dashboard/evaluation-finale') || $isActive('/dashboard/grades/reconduits') || $isActive('/dashboard/grades') || $isActive('/dashboard/reconduits') || $isActive('/dashboard/reconduits/transfers') || $isActive('/dashboard/schedule')) ? 'open' : ''); ?>">
                            <a href="<?php echo e(url('dashboard/grades/reconduits')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/grades/reconduits')); ?>" title="تسجيل نقاط المتربصين المستمرين"><i class="fa-solid fa-pen-to-square text-warning"></i> <span>تسجيل نقاط المتربصين المستمرين</span></a>
                            <a href="<?php echo e(url('dashboard/grades')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/grades')); ?>" title="دفتر العلامات والمداولات"><i class="fa-solid fa-graduation-cap text-warning"></i> <span>دفتر العلامات والمداولات</span></a>
                            <a href="<?php echo e(url('resultats')); ?>" class="sidebar-subitem <?php echo e($isActive('/resultats')); ?>" title="التقييم سداسي"><i class="fa-solid fa-star-half-stroke text-warning"></i> <span>التقييم سداسي</span></a>
                            <a href="<?php echo e(url('dashboard/reconduits')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/reconduits')); ?>" title="المتربصين المستمرين"><i class="fa-solid fa-users-viewfinder text-warning"></i> <span>المتربصين المستمرين</span></a>
                            ...
                            <a href="<?php echo e(url('dashboard/schedule')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/schedule')); ?>" title="استعمال الزمن"><i class="fa-solid fa-calendar-days text-warning"></i> <span>استعمال الزمن</span></a>
                            <a href="<?php echo e(url('dashboard/gestion-evaluations')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/gestion-evaluations')); ?>" title="تسيير التقييمات"><i class="fa-solid fa-list-check text-warning"></i> <span>تسيير التقييمات</span></a>
                            <a href="<?php echo e(url('dashboard/evaluation-finale')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/evaluation-finale')); ?>" title="التقييم نهائي"><i class="fa-solid fa-flag-checkered text-warning"></i> <span>التقييم نهائي</span></a>
                        </div>
                    </div>
                    ...
                    <div class="sidebar-dropdown">
                        ...
                        <div class="sidebar-submenu <?php echo e(($isActive('/dashboard/partenaires') || $isActive('/dashboard/maitres-apprentissage')) ? 'open' : ''); ?>">
                            <a href="<?php echo e(url('dashboard/partenaires')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/partenaires')); ?>" title="المؤسسات الاقتصادية"><i class="fa-solid fa-building text-danger"></i> <span>المؤسسات الاقتصادية</span></a>
                            <a href="<?php echo e(url('dashboard/maitres-apprentissage')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/maitres-apprentissage')); ?>" title="معلمو التمهين"><i class="fa-solid fa-person-chalkboard text-danger"></i> <span>معلمو التمهين</span></a>
                        </div>
                    </div>
                <?php else: ?>
            ...
            <?php if(in_array($roleCode, ['admin', 'dfep', 'central', 'etablissement', 'directeur']) && (int)(session('user.IDMode_formation') ?? 0) !== 10 && $dept !== 'diplomes' && $dept !== 'administration' && !$isDfmUser && !$isDrhUser && !$isDepUser && !$isDeohUser && !$isDosfpUser && !$isDfcriUser): ?>
                <div class="sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu <?php echo e($isActive('/dashboard/digital-cards') ? 'open' : ''); ?>">
                        <a href="<?php echo e(request()->is('sig/*') ? url('sig/dashboard/digital-cards?type=employee') : url('dashboard/digital-cards?type=employee')); ?>" class="sidebar-subitem <?php echo e(($isActive('/dashboard/digital-cards') && request('type', 'employee') === 'employee') ? 'active' : ''); ?>" title="بطاقات الموظفين">
                            <i class="fa-solid fa-user-tie"></i> <span>بطاقات الموظفين</span>
                        </a>
                        <a href="<?php echo e(request()->is('sig/*') ? url('sig/dashboard/digital-cards?type=trainee') : url('dashboard/digital-cards?type=trainee')); ?>" class="sidebar-subitem <?php echo e(($isActive('/dashboard/digital-cards') && request('type') === 'trainee') ? 'active' : ''); ?>" title="بطاقات المتربصين">
            ...
            <?php if(!in_array($roleCode, ['employee', 'formateur', 'dfep', 'central']) && in_array($dept, ['general', 'pedagogie'])): ?>
            <div class="sidebar-dropdown">
                <button type="button" class="sidebar-item <?php echo e($isActive('/dashboard/rnfc') ? 'active' : ''); ?>" onclick="toggleSidebarDropdown(this)" title="مدونة الشعب والقطاعات (RNFC)">
                    <i class="fa-solid fa-sitemap text-teal"></i>
                    <span>مدونة الشعب والقطاعات (RNFC)</span>
                    <i class="fa-solid fa-chevron-down ms-auto dropdown-chevron" style="font-size: 0.7rem;"></i>
                </button>
                <div class="sidebar-submenu <?php echo e($isActive('/dashboard/rnfc') ? 'open' : ''); ?>">
                    <a href="<?php echo e(url('dashboard/rnfc')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/rnfc')); ?>" title="مستكشف دليل الشعب"><i class="fa-solid fa-cubes text-teal"></i> <span>مستكشف دليل الشعب</span></a>
                    <?php if(in_array($roleCode, ['admin', 'central'])): ?>
                        <a href="<?php echo e(url('dashboard/sync')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/sync')); ?>" title="مزامنة المدونة"><i class="fa-solid fa-rotate text-teal"></i> <span>مزامنة المدونة</span></a>
                    <?php endif; ?>
                </div>
            </div>
            <?php endif; ?>
            ...
            <?php if(($hasPerm('documents') || $roleCode === 'dfep' || in_array($roleCode, ['admin', 'central', 'etablissement', 'directeur'])) && !$isDfmUser && !$isDrhUser && !$isDepUser && !$isDeohUser && !$isDosfpUser && !$isDfcriUser): ?>
                <div class="sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu <?php echo e($isActive('/dashboard/documents') ? 'open' : ''); ?>">
            ...
            <?php if(strpos($roleCode, 'dir_') === 0 && isset($depNames[$roleCode])): ?>
                ...
                ?>
                <div class="sidebar-dropdown">
                    <button type="button" class="sidebar-item active" onclick="toggleSidebarDropdown(this)" title="<?php echo e($dep['title']); ?>">
                        <i class="fa-solid <?php echo e($dep['icon']); ?>"></i>
                        <span><?php echo e($dep['title']); ?></span>
                        <i class="fa-solid fa-chevron-down ms-auto dropdown-chevron" style="font-size: 0.7rem;"></i>
                    </button>
                    <div class="sidebar-submenu open">
                        <?php $__currentLoopData = $activeTabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            $ac = (isset($_GET['tab']) && $_GET['tab'] === $t['tab']) ? 'active' : '';
                            ?>
                            <a href="/sig/dashboard?tab=<?php echo e($t['tab']); ?>" class="sidebar-subitem <?php echo e($ac); ?>" title="<?php echo e($t['label']); ?>"><i class="fa-solid <?php echo e($t['icon']); ?>"></i> <span><?php echo e($t['label']); ?></span></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            <?php elseif(in_array($roleCode, ['admin', 'ministre', 'secretaire_general'])): ?>
                <!-- Category: Central Directorates (Admin) -->
                <div class="sidebar-dropdown">
                    <button type="button" class="sidebar-item <?php echo e(isset($_GET['view_dir']) ? 'active' : ''); ?>" onclick="toggleSidebarDropdown(this)" title="المديريات المركزية">
                        <i class="fa-solid fa-building-columns"></i>
                        <span>المديريات المركزية</span>
                        <i class="fa-solid fa-chevron-down ms-auto dropdown-chevron" style="font-size: 0.7rem;"></i>
                    </button>
                    <div class="sidebar-submenu <?php echo e(isset($_GET['view_dir']) ? 'open' : ''); ?>">
                        <?php $__currentLoopData = $depNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dirKey => $dirData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="/sig/dashboard?view_dir=<?php echo e($dirKey); ?>" class="sidebar-subitem <?php echo e((isset($_GET['view_dir']) && $_GET['view_dir'] === $dirKey) ? 'active' : ''); ?>" title="<?php echo e($dirData['title']); ?>">
                                <i class="fa-solid <?php echo e($dirData['icon']); ?> text-secondary"></i> <span><?php echo e($dirData['title']); ?></span>
                            </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            ...
            <?php if($roleCode === 'admin'): ?>
                ...
                <div class="sidebar-dropdown">
                    <button type="button" class="sidebar-item <?php echo e(($isActive('/dashboard/users') || $isActive('/dashboard/permissions') || $isActive('/dashboard/roles') || $isActive('/dashboard/identities')) ? 'active' : ''); ?>" onclick="toggleSidebarDropdown(this)" title="المستخدمين والصلاحيات">
                        <i class="fa-solid fa-users-gear text-primary"></i>
                        <span>المستخدمين والصلاحيات</span>
                        <i class="fa-solid fa-chevron-down ms-auto dropdown-chevron" style="font-size: 0.7rem;"></i>
                    </button>
                    <div class="sidebar-submenu <?php echo e(($isActive('/dashboard/users') || $isActive('/dashboard/permissions') || $isActive('/dashboard/roles') || $isActive('/dashboard/identities')) ? 'open' : ''); ?>">
                        <a href="<?php echo e(url('dashboard/users')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/users')); ?>" title="إدارة الحسابات"><i class="fa-solid fa-user-check text-primary"></i> <span>إدارة الحسابات</span></a>
                        <a href="<?php echo e(url('dashboard/roles')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/roles')); ?>" title="صلاحيات المستخدمين"><i class="fa-solid fa-user-shield text-danger"></i> <span>صلاحيات المستخدمين</span></a>
                        <a href="<?php echo e(url('dashboard/permissions')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/permissions')); ?>" title="تخصيص صلاحيات الحسابات"><i class="fa-solid fa-key text-warning"></i> <span>تخصيص الصلاحيات</span></a>
                        <a href="<?php echo e(url('dashboard/identities')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/identities')); ?>" title="سجل الهويات الوطني"><i class="fa-solid fa-id-card text-success"></i> <span>سجل الهويات الوطني</span></a>
                    </div>
                </div>

                <!-- Menu 2: Database & System Tools -->
                <div class="sidebar-dropdown">
                    <button type="button" class="sidebar-item <?php echo e(($isActive('/dashboard/sync') || $isActive('/dashboard/database') || $isActive('/dashboard/import') || $isActive('/dashboard/hfsql-export') || $isActive('/dashboard/audit-logs')) ? 'active' : ''); ?>" onclick="toggleSidebarDropdown(this)" title="أدوات وقواعد البيانات">
                        <i class="fa-solid fa-database text-success"></i>
                        <span>أدوات وقواعد البيانات</span>
                        <i class="fa-solid fa-chevron-down ms-auto dropdown-chevron" style="font-size: 0.7rem;"></i>
                    </button>
                    <div class="sidebar-submenu <?php echo e(($isActive('/dashboard/sync') || $isActive('/dashboard/database') || $isActive('/dashboard/import') || $isActive('/dashboard/hfsql-export') || $isActive('/dashboard/audit-logs')) ? 'open' : ''); ?>">
                        <a href="<?php echo e(url('dashboard/sync')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/sync')); ?>" title="مزامنة البيانات (HFSQL)"><i class="fa-solid fa-server text-success"></i> <span>مزامنة البيانات (HFSQL)</span></a>
                        <a href="<?php echo e(url('dashboard/hfsql-export')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/hfsql-export')); ?>" title="مزامنة HFSQL &larr; MySQL"><i class="fa-solid fa-arrows-rotate text-info"></i> <span>مزامنة الصادرات</span></a>
                        <a href="<?php echo e(url('dashboard/database')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/database')); ?>" title="إدارة قاعدة البيانات"><i class="fa-solid fa-screwdriver-wrench text-warning"></i> <span>إدارة قاعدة البيانات</span></a>
                        <a href="<?php echo e(url('dashboard/import')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/import')); ?>" title="استيراد وتصدير البيانات"><i class="fa-solid fa-file-import text-primary"></i> <span>استيراد وتصدير البيانات</span></a>
                        <a href="<?php echo e(url('dashboard/audit-logs')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/audit-logs')); ?>" title="سجل العمليات"><i class="fa-solid fa-list-check text-secondary"></i> <span>سجل العمليات</span></a>
                    </div>
                </div>

                <!-- Menu 3: Advanced Settings & APIs -->
                <div class="sidebar-dropdown">
                    <button type="button" class="sidebar-item <?php echo e(($isActive('/dashboard/settings') || $isActive('/dashboard/settings/takwin') || $isActive('/dashboard/settings/diplome') || $isActive('/dashboard/reports') || $isActive('/dashboard/builder') || $isActive('/dashboard/api-center') || $isActive('/dashboard/archive')) ? 'active' : ''); ?>" onclick="toggleSidebarDropdown(this)" title="إعدادات المنصة المتقدمة">
                        <i class="fa-solid fa-sliders text-warning"></i>
                        <span>إعدادات المنصة المتقدمة</span>
                        <i class="fa-solid fa-chevron-down ms-auto dropdown-chevron" style="font-size: 0.7rem;"></i>
                    </button>
                    <div class="sidebar-submenu <?php echo e(($isActive('/dashboard/settings') || $isActive('/dashboard/settings/takwin') || $isActive('/dashboard/settings/diplome') || $isActive('/dashboard/reports') || $isActive('/dashboard/builder') || $isActive('/dashboard/api-center') || $isActive('/dashboard/archive')) ? 'open' : ''); ?>">
                        <a href="<?php echo e(url('dashboard/settings')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/settings', true)); ?>" title="إعدادات المنصة"><i class="fa-solid fa-gear text-primary"></i> <span>إعدادات النظام العامة</span></a>
                        <a href="<?php echo e(url('dashboard/settings/takwin')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/settings/takwin')); ?>" title="إعدادات Takwin API"><i class="fa-solid fa-cloud-arrow-down text-info"></i> <span>إعدادات Takwin API</span></a>
                        <a href="<?php echo e(url('dashboard/settings/diplome')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/settings/diplome')); ?>" title="تخصيص وتصميم الشهادات"><i class="fa-solid fa-palette text-success"></i> <span>تصميم الشهادات</span></a>
                        <a href="<?php echo e(url('dashboard/reports')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/reports')); ?>" title="منشئ التقارير"><i class="fa-solid fa-chart-bar text-warning"></i> <span>منشئ التقارير</span></a>
                        <a href="<?php echo e(url('dashboard/builder')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/builder')); ?>" title="منشئ لوحات التحكم"><i class="fa-solid fa-compass-drafting text-danger"></i> <span>منشئ لوحات التحكم</span></a>
                        <a href="<?php echo e(url('dashboard/api-center')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/api-center')); ?>" title="مركز الاتصال الرقمي"><i class="fa-solid fa-satellite-dish text-info"></i> <span>مركز الاتصال الرقمي</span></a>
                        <a href="<?php echo e(url('dashboard/archive')); ?>" class="sidebar-subitem <?php echo e($isActive('/dashboard/archive')); ?>" title="بوابة الأرشيف (HFSQL)"><i class="fa-solid fa-box-archive text-secondary"></i> <span>بوابة الأرشيف (HFSQL)</span></a>
                    </div>
                </div>
            <?php endif; ?>
            <?php endif; ?>
...
<!-- ══ Section: الإدارة والخدمات العامة ══ -->
        ...
        <div style="border-top: 1px solid rgba(255, 255, 255, 0.08); padding: 0.75rem 0;">
            <a href="<?php echo e(url('dashboard/profile')); ?>" class="sidebar-item <?php echo e($isActive('/dashboard/profile')); ?>">
                <i class="fa-solid fa-user-gear"></i>
                <span>الملف الإداري</span>
            </a>
            <a href="<?php echo e(request()->is('sig/*') ? url('sig/logout') : url('logout')); ?>" class="sidebar-item text-danger">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="dropdown">
                        <a href="#" class="cb-profile dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                            <?php if($navAvatarUrl): ?>
                                <img src="<?php echo e($navAvatarUrl); ?>" class="cb-avatar" style="object-fit:cover;" width="32" height="32">
                            <?php else: ?>
                                <div class="cb-avatar"><?php echo e($navInitials); ?></div>
                            <?php endif; ?>
                            <div class="cb-profile-text">
                                <span class="cb-profile-name"><?php echo e($user['nom_complet'] ?? 'المشرف'); ?></span>
                                <span class="cb-profile-role"><?php echo e($user['role_ar'] ?? ''); ?></span>
                            </div>
                        ...
                        <ul class="dropdown-menu dropdown-menu-start mt-2">
                            ...
                            <li>
                                <a class="dropdown-item text-danger" href="<?php echo e(request()->is('sig/*') ? url('sig/logout') : url('logout')); ?>">
                ...
                <div class="global-filter-bar mb-4 animate__animated animate__fadeIn">
                    <form method="GET" action="" class="row g-3 align-items-end p-3 rounded-4 shadow-sm border" style="background: var(--bg-surface-elevated); backdrop-filter: blur(15px); -webkit-backdrop-filter: blur(15px); border-color: var(--border-portal); border-radius: 20px;">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <select name="filter_etablissement" id="global-filter-etablissement" class="form-select border-0 shadow-sm py-2.5 px-3 bg-light rounded-3 w-100" style="font-size: 0.85rem; font-family: 'Cairo'; font-weight: 600;" <?php echo e((in_array($role, ['etablissement', 'directeur'])) ? 'disabled' : ''); ?>>
                                <option value="">كل المؤسسات / Etablissements</option>
                                <?php $__currentLoopData = $filter_etablissements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $et): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($et['id']); ?>" data-wilaya="<?php echo e($et['wilaya_id']); ?>" <?php echo e((isset($_GET['filter_etablissement']) && $_GET['filter_etablissement'] == $et['id']) || ($role === 'directeur' && $etabId == $et['id']) ? 'selected' : ''); ?>>
                                        <?php echo e($et['nom_ar']); ?>
                        ...
                        <div class="col-12 col-md-3">
                            ...
                            <select name="filter_mode" id="global-filter-mode" class="form-select border-0 shadow-sm py-2.5 px-3 bg-light rounded-3 w-100" style="font-size: 0.85rem; font-family: 'Cairo'; font-weight: 600;">
                                ...
                                <?php $__currentLoopData = $filter_modes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($m['id']); ?>" <?php echo e((isset($_GET['filter_mode']) && $_GET['filter_mode'] == $m['id']) ? 'selected' : ''); ?>>
                                        <?php echo e($m['libelle_ar']); ?>
...
<nav class="mobile-bottom-nav">
    <a href="<?php echo e(url('dashboard')); ?>" class="mob-nav-item <?php echo e(($isActive('/dashboard', true) && !isset($_GET['tab'])) ? 'active' : ''); ?>">
        <i class="fa-solid fa-chart-line"></i>
        <span>الرئيسية</span>
    </a>
    ...
    <a href="<?php echo e(url('dashboard/profile')); ?>" class="mob-nav-item <?php echo e($isActive('/dashboard/profile')); ?>">
        <i class="fa-solid fa-user-gear"></i>
        <span>الملف</span>
    </a>
    <a href="<?php echo e(request()->is('sig/*') ? url('sig/logout') : url('logout')); ?>" class="mob-nav-item text-danger">
        <i class="fa-solid fa-power-off"></i>
        <span>خروج</span>
    </a>
</nav>
        ...
        <div class="modal-content glass-panel border-0 shadow-lg" style="border-radius: 20px;">
            <div class="modal-body p-4" style="direction: rtl;">
                ...
                <div class="d-flex flex-column gap-2" id="commandPaletteResults">
                    <a href="<?php echo e(url('dashboard')); ?>" class="d-flex align-items-center justify-content-between p-3 rounded-4 text-decoration-none bg-light-hover" style="border: 1px solid var(--border); transition: all 0.2s;">
                    ...
                    <a href="<?php echo e(url('resultats')); ?>" class="d-flex align-items-center justify-content-between p-3 rounded-4 text-decoration-none bg-light-hover" style="border: 1px solid var(--border); transition: all 0.2s;">
                        <span class="text-dark fw-bold"><i class="fa-solid fa-star-half-stroke text-primary me-2"></i> بوابة تقييم الأداء السداسي</span>
                        <i class="fa-solid fa-chevron-left text-muted"></i>
                    </a>
                    <a href="<?php echo e(url('dashboard/profile')); ?>" class="d-flex align-items-center justify-content-between p-3 rounded-4 text-decoration-none bg-light-hover" style="border: 1px solid var(--border); transition: all 0.2s;">
...
<?php /**PATH C:\xampp\htdocs\sig\resources\views/layouts/main.blade.php ENDPATH**/ ?>