...
<div class="animate__animated animate__fadeIn">
    ...
    <?php if(in_array($role, ['admin', 'central', 'dfep'])): ?>
    <div class="mb-4">
                    ...
                    <div class="tab-pane fade show active" id="budgets-pane" role="tabpanel" aria-labelledby="budgets-tab">
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0 text-center small">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $rawBudgetsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="text-right fw-bold text-dark" style="color: var(--text-main) !important;"><?php echo e($rb->label); ?></td>
                                            <td><?php echo e($rb->annee_name ?? '2026/2025'); ?></td>
                                            <td style="font-family:'Inter';" class="text-success fw-bold"><?php echo e(number_format($rb->ae, 0, '.', ',')); ?> دج</td>
                                            <td style="font-family:'Inter';" class="text-primary"><?php echo e(number_format($rb->cp, 0, '.', ',')); ?> دج</td>
                                            <td><?php echo e($rb->etab_name ?? 'الإدارة المركزية'); ?></td>
                                            <td>
                                                <button class="btn btn-sm btn-outline-warning rounded-circle me-1" onclick="openEditBudgetModal(<?php echo e($rb->id); ?>, '<?php echo e(addslashes($rb->label)); ?>', <?php echo e($rb->ae); ?>, <?php echo e($rb->cp); ?>, <?php echo e($rb->annee_id ?? 'null'); ?>, <?php echo e($rb->etab_id ?? 'null'); ?>)" title="تعديل">
                                                    <i class="fa-solid fa-pen"></i>
                                                </button>
                                                <button class="btn btn-sm btn-outline-danger rounded-circle" onclick="deleteBudget(<?php echo e($rb->id); ?>)" title="حذف">
                    ...
                    <div class="tab-pane fade" id="operations-pane" role="tabpanel" aria-labelledby="operations-tab">
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0 text-center small">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $rawOperationsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="text-right fw-bold text-dark" style="color: var(--text-main) !important; max-width: 220px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="<?php echo e($ro->name); ?>"><?php echo e($ro->name); ?></td>
                                            <td style="font-family:'Inter'; font-size: 0.8rem;" class="text-muted"><?php echo e($ro->num); ?></td>
                                            <td style="font-family:'Inter';"><?php echo e(number_format($ro->apini, 0, '.', ',')); ?> دج</td>
                                            <td style="font-family:'Inter';"><?php echo e(number_format($ro->apfinal, 0, '.', ',')); ?> دج</td>
                                            <td style="font-family:'Inter';" class="text-warning fw-bold"><?php echo e(number_format($ro->eng, 0, '.', ',')); ?> دج</td>
                                            <td style="font-family:'Inter';" class="text-success fw-bold"><?php echo e(number_format($ro->pay, 0, '.', ',')); ?> دج</td>
                                            <td>
                                                <span class="badge bg-success-subtle text-success rounded-pill px-2.5"><?php echo e($ro->rate); ?>%</span>
                                            </td>
                                            <td><?php echo e($ro->wilaya_name ?? 'الكل'); ?></td>
                                            <td>
                                                <button class="btn btn-sm btn-outline-warning rounded-circle me-1" onclick="openEditOperationModal(<?php echo e($ro->id); ?>, '<?php echo e(addslashes($ro->name)); ?>', '<?php echo e(addslashes($ro->num)); ?>', <?php echo e($ro->apini); ?>, <?php echo e($ro->apact); ?>, <?php echo e($ro->apfinal); ?>, <?php echo e($ro->eng); ?>, <?php echo e($ro->pay); ?>, <?php echo e($ro->wilaya_id); ?>)" title="تعديل">
                                                    <i class="fa-solid fa-pen"></i>
                                                </button>
                                                <button class="btn btn-sm btn-outline-danger rounded-circle" onclick="deleteOperation(<?php echo e($ro->id); ?>)" title="حذف">
                                                    <i class="fa-solid fa-trash"></i>
                                                </button>
                                            </td>
                                        </tr>
                    ...
                    <div class="tab-pane fade" id="grants-dashboard-pane" role="tabpanel" aria-labelledby="grants-dashboard-tab">
                        ...
                        <div class="row g-3 mb-4" style="margin-top: 0.5rem;">
                            <div class="col-md-4">
                                <div class="card border-0 shadow-sm p-4 h-100" style="border-radius: 16px; background: var(--card-bg); border: 1px solid var(--card-border) !important; border-bottom: 4px solid #3b82f6 !important;">
                                    ...
                                    <h2 class="fw-bold mb-1" style="font-size: 1.75rem; font-family:'Cairo'; color: var(--text-main);"><?php echo e(number_format($totalApprenantsNationwide)); ?> متربص</h2>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card border-0 shadow-sm p-4 h-100" style="border-radius: 16px; background: var(--card-bg); border: 1px solid var(--card-border) !important; border-bottom: 4px solid #10b981 !important;">
                                    ...
                                    <h2 class="fw-bold mb-1 text-success" style="font-size: 1.75rem; font-family:'Cairo';"><?php echo e(number_format($totalPaidBoursesNationwide)); ?> مستفيد</h2>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card border-0 shadow-sm p-4 h-100" style="border-radius: 16px; background: var(--card-bg); border: 1px solid var(--card-border) !important; border-bottom: 4px solid #f59e0b !important;">
                                    ...
                                    <h2 class="fw-bold mb-1 text-warning" style="font-size: 1.75rem; font-family:'Cairo';"><?php echo e($nationalPercentage); ?>%</h2>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive" style="max-height: 400px; overflow-y: auto;">
                            <table class="table table-hover align-middle mb-0 text-center small">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $bourseWilayaStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="text-right fw-bold text-dark" style="color: var(--text-main) !important;"><?php echo e($w['wilaya_nom']); ?></td>
                                            <td class="fw-bold"><?php echo e(number_format($w['total_apprenants'])); ?></td>
                                            <td class="text-primary fw-bold"><?php echo e(number_format($w['paid_bourses'])); ?></td>
                                            <td class="text-success fw-bold"><?php echo e($w['percentage']); ?>%</td>
                                            <td>
                                                <div style="display: flex; flex-direction: column; gap: 4px;">
                                                    <div style="display: flex; justify-content: space-between; align-items: center; font-size: 0.72rem; font-weight: 700;">
                                                        <?php if($w['percentage'] >= 100): ?>
                                                            <span class="badge bg-success-subtle text-success rounded-pill px-2.5">مكتمل 100%</span>
                                                        <?php else: ?>
                                                            <span class="badge bg-warning-subtle text-warning rounded-pill px-2.5">قيد الصب (<?php echo e($w['percentage']); ?>%)</span>
                                                        <?php endif; ?>
                                                    </div>
                                                    <div style="width: 100%; background: var(--border, #dde3ef); border-radius: 4px; height: 8px; overflow: hidden; position: relative;">
                                                        <div style="width: <?php echo e(min($w['percentage'], 100)); ?>%; background: <?php echo e($w['percentage'] >= 100 ? '#10b981' : ($w['percentage'] >= 50 ? '#3b82f6' : '#f59e0b')); ?>; height: 100%; border-radius: 4px;"></div>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                    ...
                    <div class="tab-pane fade" id="employees-dashboard-pane" role="tabpanel" aria-labelledby="employees-dashboard-tab">
                        ...
                        <div class="row g-3 mb-4" style="margin-top: 0.5rem;">
                            <div class="col-md-4">
                                <div class="card border-0 shadow-sm p-4 h-100" style="border-radius: 16px; background: var(--card-bg); border: 1px solid var(--card-border) !important; border-bottom: 4px solid #3b82f6 !important;">
                                    ...
                                    <h2 class="fw-bold mb-1" style="font-size: 1.75rem; font-family:'Cairo'; color: var(--text-main);"><?php echo e(number_format($totalEmployeesNationwide)); ?> موظف</h2>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card border-0 shadow-sm p-4 h-100" style="border-radius: 16px; background: var(--card-bg); border: 1px solid var(--card-border) !important; border-bottom: 4px solid #10b981 !important;">
                                    ...
                                    <h2 class="fw-bold mb-1 text-success" style="font-size: 1.75rem; font-family:'Cairo';"><?php echo e(number_format($totalActiveAccountsNationwide)); ?> حساب</h2>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card border-0 shadow-sm p-4 h-100" style="border-radius: 16px; background: var(--card-bg); border: 1px solid var(--card-border) !important; border-bottom: 4px solid #f59e0b !important;">
                                    ...
                                    <h2 class="fw-bold mb-1 text-warning" style="font-size: 1.75rem; font-family:'Cairo';"><?php echo e($nationalEmployeePercentage); ?>%</h2>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive" style="max-height: 400px; overflow-y: auto;">
                            <table class="table table-hover align-middle mb-0 text-center small">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $employeeStatsArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="text-right fw-bold text-dark" style="color: var(--text-main) !important;"><?php echo e($w['wilaya_nom']); ?></td>
                                            <td class="fw-bold"><?php echo e(number_format($w['total_employees'])); ?></td>
                                            <td class="text-primary fw-bold"><?php echo e(number_format($w['active_accounts'])); ?></td>
                                            <td class="text-success fw-bold"><?php echo e($w['percentage']); ?>%</td>
                                            <td>
                                                <div style="display: flex; flex-direction: column; gap: 4px;">
                                                    <div style="display: flex; justify-content: space-between; align-items: center; font-size: 0.72rem; font-weight: 700;">
                                                        <?php if($w['percentage'] >= 100): ?>
                                                            <span class="badge bg-success-subtle text-success rounded-pill px-2.5">مكتمل 100%</span>
                                                        <?php else: ?>
                                                            <span class="badge bg-warning-subtle text-warning rounded-pill px-2.5">قيد التفعيل (<?php echo e($w['percentage']); ?>%)</span>
                                                        <?php endif; ?>
                                                    </div>
                                                    <div style="width: 100%; background: var(--border, #dde3ef); border-radius: 4px; height: 8px; overflow: hidden; position: relative;">
                                                        <div style="width: <?php echo e(min($w['percentage'], 100)); ?>%; background: <?php echo e($w['percentage'] >= 100 ? '#10b981' : ($w['percentage'] >= 50 ? '#3b82f6' : '#f59e0b')); ?>; height: 100%; border-radius: 4px;"></div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select rounded-3" id="notifTarget" name="target_wilaya">
                                ...
                                <?php $__currentLoopData = $wilayasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($w['id']); ?>">ولاية <?php echo e($w['nom_ar']); ?> (<?php echo e(sprintf("%02d", $w['code'])); ?>)</option>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select rounded-3" id="budgetAnnee" name="annee">
                            <?php $__currentLoopData = $yearsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($y['id']); ?>"><?php echo e($y['libelle_ar'] ?? $y['Nom'] ?? 'سنة'); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="mb-3">
                        ...
                        <select class="form-select rounded-3" id="budgetEtab" name="etablissement_id">
                            ...
                            <?php $__currentLoopData = $etabsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($e['id']); ?>"><?php echo e($e['nom_ar']); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select rounded-3" id="opWilaya" name="wilaya_id" required>
                            ...
                            <?php $__currentLoopData = $wilayasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($w['id']); ?>"><?php echo e(sprintf("%02d", $w['code'])); ?> - <?php echo e($w['nom_ar']); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sig\resources\views/dashboard/departments/finance.blade.php ENDPATH**/ ?>