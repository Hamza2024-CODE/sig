<?php $__env->startSection('title', 'مركز بطاقات التكوين المهني الرقمية'); ?>
    ...
    <div class="glass-panel p-4 mb-4" style="border-right: 6px solid var(--electric) !important;">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            ...
            <div class="btn-group rounded-pill p-1 bg-light border">
                <a href="?type=employee" class="btn btn-sm rounded-pill px-4 fw-bold <?php echo e($type === 'employee' ? 'btn-primary' : 'btn-light text-dark'); ?>">
                    <i class="fa-solid fa-briefcase me-1"></i> بطاقات الموظفين
                </a>
                <a href="?type=trainee" class="btn btn-sm rounded-pill px-4 fw-bold <?php echo e($type === 'trainee' ? 'btn-primary' : 'btn-light text-dark'); ?>">
            ...
            <div class="glass-panel p-4 h-100 d-flex flex-column justify-content-between">
                <div>
                    ...
                    <form method="GET" action="" class="row g-2 mb-4">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="filter_search" class="form-control rounded-3" placeholder="ابحث بالاسم، اللقب، NIN، التخصص..." value="<?php echo e($selected_filters['search'] ?? ''); ?>">
                        </div>
                        <div class="col-md-2">
                            <select name="filter_wilaya" id="filter-wilaya" onchange="onWilayaChange()" class="form-select rounded-3">
                                ...
                                <?php $__currentLoopData = $filter_wilayas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($w['id']); ?>" <?php echo e(($selected_filters['wilaya'] ?? '') == $w['id'] ? 'selected' : ''); ?>>
                                        <?php echo e($w['nom_ar']); ?>
                        ...
                        <div class="col-md-2">
                            <select name="filter_etab" id="filter-etablissement" class="form-select rounded-3" data-init="true">
                                ...
                                <?php $__currentLoopData = $filter_etablissements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($e['id']); ?>" data-wilaya="<?php echo e($e['wilaya_id']); ?>" <?php echo e(($selected_filters['etab'] ?? '') == $e['id'] ? 'selected' : ''); ?>>
                                        <?php echo e($e['nom_ar']); ?>
                        ...
                        <div class="col-md-2">
                            <select name="filter_grade" class="form-select rounded-3">
                                ...
                                <?php $__currentLoopData = $filter_grades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($g['id']); ?>" <?php echo e(($selected_filters['grade'] ?? '') == $g['id'] ? 'selected' : ''); ?>>
                                        <?php echo e($g['nom_ar']); ?>
                        ...
                        <div class="col-md-2">
                            <select name="filter_fonction" class="form-select rounded-3">
                                ...
                                <?php $__currentLoopData = $filter_fonctions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($f['id']); ?>" <?php echo e(($selected_filters['fonction'] ?? '') == $f['id'] ? 'selected' : ''); ?>>
                                        <?php echo e($f['nom_ar']); ?>
                    ...
                    <form method="GET" action="" class="row g-2 mb-4">
                        <input type="hidden" name="type" value="<?php echo e($type); ?>">
                        <div class="col-md-4">
                            <input type="text" name="filter_search" class="form-control rounded-3" placeholder="ابحث بالاسم، اللقب، NIN..." value="<?php echo e($selected_filters['search'] ?? ''); ?>">
                        </div>
                        <div class="col-md-2">
                            <select name="filter_wilaya" id="filter-wilaya" onchange="onWilayaChange()" class="form-select rounded-3">
                                <option value="">كل الولايات</option>
                        ...
                        <div class="col-md-2">
                            <select name="filter_branche" class="form-select rounded-3">
                                ...
                                <?php $__currentLoopData = $filter_branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($b['id']); ?>" <?php echo e(($selected_filters['branche'] ?? '') == $b['id'] ? 'selected' : ''); ?>>
                                        <?php echo e($b['libelle_ar']); ?>
                        ...
                        <div class="col-md-2">
                            <select name="filter_mode" class="form-select rounded-3">
                                ...
                                <?php $__currentLoopData = $filter_modes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($m['code']); ?>" <?php echo e(($selected_filters['mode'] ?? '') == $m['code'] ? 'selected' : ''); ?>>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle">
                            <thead class="bg-light text-muted small fw-bold">
                                <tr>
                                    <th>الاسم واللقب</th>
                                    <th><?php echo e($type === 'employee' ? 'المادة/الوظيفة' : 'التخصص التكويني'); ?></th>
                                    <th>المؤسسة</th>
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr style="cursor: pointer;" onclick="loadIDCard(<?php echo e($r['id']); ?>, '<?php echo e($type); ?>')">
                                            <td>
                                                <strong class="text-dark"><?php echo e($r['nom']); ?> <?php echo e($r['prenom']); ?></strong>
                                                <div class="text-muted" style="font-size: 0.68rem; font-family: 'Outfit';">NIN: <?php echo e($r['nin'] ?? 'N/A'); ?></div>
                                            </td>
                                            <td class="small fw-semibold text-primary"><?php echo e($r['spec_ar'] ?? 'غير محدد'); ?></td>
                                            <td class="small text-muted"><?php echo e($r['etab_nom'] ?? 'المديرية الولائية'); ?></td>
                                            <td class="text-center">
                                                <button class="btn btn-xs btn-outline-primary rounded-pill px-2.5 fw-bold" onclick="if(typeof event !== 'undefined') event.stopPropagation(); loadIDCard(<?php echo e($r['id']); ?>, '<?php echo e($type); ?>')">
                        ...
                        <nav>
                            <ul class="pagination pagination-sm gap-1">
                                <li class="page-item <?php echo e($page <= 1 ? 'disabled' : ''); ?>">
                                    <a class="page-link rounded-3" href="?type=<?php echo e($type); ?>&page=<?php echo e($page - 1); ?>&filter_search=<?php echo e($selected_filters['search']); ?>&filter_wilaya=<?php echo e($selected_filters['wilaya']); ?>&filter_etab=<?php echo e($selected_filters['etab']); ?>&filter_mode=<?php echo e($selected_filters['mode'] ?? ''); ?>&filter_branche=<?php echo e($selected_filters['branche'] ?? ''); ?>&filter_grade=<?php echo e($selected_filters['grade'] ?? ''); ?>&filter_fonction=<?php echo e($selected_filters['fonction'] ?? ''); ?>">السابق</a>
                                </li>
                                <?php for($i = 1; $i <= $totalPages; $i++): ?>
                                    <li class="page-item <?php echo e($page == $i ? 'active' : ''); ?>">
                                        <a class="page-link rounded-3" href="?type=<?php echo e($type); ?>&page=<?php echo e($i); ?>&filter_search=<?php echo e($selected_filters['search']); ?>&filter_wilaya=<?php echo e($selected_filters['wilaya']); ?>&filter_etab=<?php echo e($selected_filters['etab']); ?>&filter_mode=<?php echo e($selected_filters['mode'] ?? ''); ?>&filter_branche=<?php echo e($selected_filters['branche'] ?? ''); ?>&filter_grade=<?php echo e($selected_filters['grade'] ?? ''); ?>&filter_fonction=<?php echo e($selected_filters['fonction'] ?? ''); ?>"><?php echo e($i); ?></a>
                                    </li>
                                <?php endfor; ?>
                                <li class="page-item <?php echo e($page >= $totalPages ? 'disabled' : ''); ?>">
                                    <a class="page-link rounded-3" href="?type=<?php echo e($type); ?>&page=<?php echo e($page + 1); ?>&filter_search=<?php echo e($selected_filters['search']); ?>&filter_wilaya=<?php echo e($selected_filters['wilaya']); ?>&filter_etab=<?php echo e($selected_filters['etab']); ?>&filter_mode=<?php echo e($selected_filters['mode'] ?? ''); ?>&filter_branche=<?php echo e($selected_filters['branche'] ?? ''); ?>&filter_grade=<?php echo e($selected_filters['grade'] ?? ''); ?>&filter_fonction=<?php echo e($selected_filters['fonction'] ?? ''); ?>">التالي</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
...
<script>
    ...
    function loadIDCard(id, type) {
        ...
        const endpoint = type === 'employee' 
            ? `<?php echo e(url('dashboard/espace-employe/get')); ?>/${id}` 
            : `<?php echo e(url('dashboard/digital-cards/trainee')); ?>/${id}`;
        ...
        fetch(endpoint)
            ...
            .then(data => {
                ...
                if (type === 'employee') {
                    ...
                    let verifyUrl = "<?php echo e(url('verify/card/employee')); ?>/" + (emp.secure_id || '');
                    ...
                    // Generate dynamic QR code image inside qrContainer
                    let verifyUrl = "<?php echo e(url('verify/card/trainee')); ?>/" + (trainee.secure_id || '');
                    document.getElementById('qrContainer').innerHTML = `<img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${encodeURIComponent(verifyUrl)}" alt="QR Code" style="width: 58px; height: 58px; border-radius: 4px;">`;
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sig\resources\views/admin/digital-cards/index.blade.php ENDPATH**/ ?>