<?php $__env->startSection('title', $title ?? 'إحصائيات المكونين حسب السن والشعب التكوينية'); ?>
...
<div class="animate__animated animate__fadeIn" style="font-family:'Cairo', sans-serif;">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        ...
        <div class="d-flex gap-2 no-print">
            <a href="<?php echo e(url('dashboard/formateurs')); ?>" class="btn btn-outline-secondary rounded-pill px-3 fw-bold btn-sm shadow-sm d-inline-flex align-items-center gap-1">
    ...
    <div class="card border-0 shadow-sm p-3 mb-4 no-print" style="border-radius:16px; background:var(--card-bg); border:1px solid var(--card-border)!important;">
        <form method="GET" action="<?php echo e(url('dashboard/formateurs/age-distribution')); ?>" class="row g-2 align-items-end">
            ...
            <div class="col-12 col-md-auto d-flex gap-2">
                ...
                <a href="<?php echo e(url('dashboard/formateurs/age-distribution')); ?>?tab=<?= htmlspecialchars($active_tab) ?>" class="btn btn-outline-secondary rounded-pill px-3 fw-bold"
    ...
    <ul class="nav nav-pills mb-3 no-print gap-2" id="statsTab" role="tablist" style="font-size:0.9rem;">
        <li class="nav-item" role="presentation">
            <a href="<?php echo e(url('dashboard/formateurs/age-distribution')); ?>?tab=aggregated&search=<?php echo e(request('search')); ?>&filter_branch=<?php echo e(request('filter_branch')); ?>&filter_wilaya=<?php echo e(request('filter_wilaya')); ?>&filter_etab=<?php echo e(request('filter_etab')); ?>"
               class="nav-link rounded-pill px-4 fw-bold d-flex align-items-center gap-2 <?php echo e($active_tab === 'aggregated' ? 'active' : 'bg-white text-muted border'); ?>"
               style="<?php echo e($active_tab === 'aggregated' ? 'background-color:#482b8f; color:#fff;' : ''); ?>">
                <i class="fa-solid fa-table-cells"></i>
                التوزيع الإجمالي (شعبة / تخصص / فئة عمرية)
            </a>
        </li>
        <li class="nav-item" role="presentation">
            <a href="<?php echo e(url('dashboard/formateurs/age-distribution')); ?>?tab=detailed&search=<?php echo e(request('search')); ?>&filter_branch=<?php echo e(request('filter_branch')); ?>&filter_wilaya=<?php echo e(request('filter_wilaya')); ?>&filter_etab=<?php echo e(request('filter_etab')); ?>"
               class="nav-link rounded-pill px-4 fw-bold d-flex align-items-center gap-2 <?php echo e($active_tab === 'detailed' ? 'active' : 'bg-white text-muted border'); ?>"
               style="<?php echo e($active_tab === 'detailed' ? 'background-color:#482b8f; color:#fff;' : ''); ?>">
        ...
        <div class="tab-pane fade show active" role="tabpanel">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3 no-print">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<?php echo e(url('dashboard/formateurs/age-distribution/export')); ?>?search=<?php echo e(request('search')); ?>&filter_branch=<?php echo e(request('filter_branch')); ?>&filter_wilaya=<?php echo e(request('filter_wilaya')); ?>&filter_etab=<?php echo e(request('filter_etab')); ?>"
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sig\resources\views/admin/formateurs/age_distribution.blade.php ENDPATH**/ ?>